...
/*!
 * @class VirtualJoystickComp
 * @brief Standalone component Class
 *
 */
public class VirtualJoystickComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(VirtualJoystick.component_conf);
      mgr.registerFactory(prop, new VirtualJoystick(), new VirtualJoystick());

      // Create a component
      RTObject_impl comp = mgr.createComponent("VirtualJoystick");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        VirtualJoystickComp init = new VirtualJoystickComp();
